...
const About = () => {
  ...
  return (
    <motion.section
      ...
      id="about"
    >
      <Title title="About Me" item={MainItem} />
      <div className={styles.container}>
        <div className={styles.wrapper}>
          ...
          <motion.p variants={MainItem}>
            ...
            to the idea of relocation. I have been developing and deploying web
            applications since January of 2020 and have enjoyed the many aspects
            of creativity and engineering that go into making unique digital
            experiences.
          </motion.p>
          <motion.p variants={MainItem}>
        ...
        <motion.div className={styles.logoWrapper} variants={MainItem}>
